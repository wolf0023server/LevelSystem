...
execute unless entity @e[type=armor_stand,tag=levelsystem] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:0b,Invulnerable:1b,Small:0b,Invisible:1b,Tags:["levelsystem"]}
